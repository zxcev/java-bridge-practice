...
public final class InputView {
    ...
    private static final String INPUT_NEXT_GAME_COMMAND_MSG = "\n게임을 다시 시도할지 여부를 입력해주세요. (재시도: R, 종료: Q)";
    ...
    public static GameCommand readGameCommand() {
        return RetryHandler.handleRetry(InputView::_inputNextGameCommand);
    }
    ...
    private static GameCommand _inputNextGameCommand() {
        System.out.println(INPUT_NEXT_GAME_COMMAND_MSG);
        final String input = readLine();
